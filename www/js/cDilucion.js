...
function prep() {
    ...
    enlace.href = 'preparar.html?id=' + id + '&num=' + eligeNum + '&dil=' + eligeDil;
};
...
function prepCapt() {
    ...
    enlaceCapt.href = 'impregnando.html?id=' + id + '&num=' + eligeNum + '&dil=' + eligeDil;
};
...
function addFav() {
    ...
    function addData() {
        ...
        transaction.onerror = (event) => {
            visto.style.display = "block";
            vis2.innerHTML = '<img class="iconos" src="img/iconos/cerrar.png" alt="X" type="img/png">Remedio duplicado';
            setTimeout(function(){
                visto.style.display = "none";
                vis2.innerHTML = '<img class="iconos" src="img/iconos/visto.png" alt="V" type="img/png">Guardado en Favoritos';
            }, 5000);
        };
...
progToma = function () {
    ...
    textoSalida.innerHTML = 'Alarma para la toma de: ' + rem + ' ' + eligeNum + ' ' + eligeDil + ' ya programada, para el día ' +  diaToma + '/' + mesToma + '/' + anoToma + ' a las ' + horaToma + ':' + minutoToma + '.';
    var mensaje = 'Toma de: ' + rem + ' ' + eligeNum + ' ' + eligeDil;
...
function draw2(remCanvas) {
    ...
    var options = {
        message: 'Prepara el vaso o la botella de agua y pincha en la imagen...', // not supported on some apps (Facebook, Instagram)
